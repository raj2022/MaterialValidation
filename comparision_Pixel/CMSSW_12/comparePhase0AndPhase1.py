...
def compareHistograms(Phase0RootFile, Phase1RootFile):
    ...
    c1.SaveAs("comparisonMBPhase0AndPhase1.png")
    c1.SaveAs("comparisonMBPhase0AndPhase1.pdf")

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('-ip0', '--inputPhase0', help='', default="CMSSW_12_matbdg_Pixel_Extended2016.root")
    parser.add_argument('-ip1', '--inputPhase1', help='', default="CMSSW_12_matbdg_Pixel_Extended2017Plan1.root")
